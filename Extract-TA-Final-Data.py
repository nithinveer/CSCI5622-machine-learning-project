...
driver.get(
    "https://www.tripadvisor.it/Attraction_Review-g657290-d2213040-Reviews-Ex_Stabilimento_Florio_delle_Tonnare_di_Favignana_e_Formica-Isola_di_Favig.html")
...
for i in range(0, 400):
    ...
    for j in range(num_page_items):
        ...
        csvWriter.writerow(
            [data[3], container[j].find_element_by_xpath(".//p[@class='partial_entry']").text.replace("\n", "")])
